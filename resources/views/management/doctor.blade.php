...
@section('content')
    ...
    <div class="modal fade " id="createDoctorModal" tabindex="-1" role="dialog" aria-labelledby="createDoctorModalTitle"
        aria-hidden="true" data-bs-backdrop="static">
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="createDoctorModalTitle"><b>Tambah Dokter</b></h5>
                ...
                <div class="modal-body">
                    <form action="" method="POST" id="formCreateDoctor" enctype="multipart/form-data" class="row">
                        ...
                        <div class="form-group col-xl-6 col-md-6 col-sm-12">
                            <label for="sipNumberCreate" class="col-form-label">No. SIP:</label>
                            <input type="text" class="form-control" name="sipNumber" id="sipNumberCreate"
                                placeholder="Masukkan nomor SIP">
                        </div>
                        <div class="form-group col-xl-6 col-md-6 col-sm-12">
                            <label for="stationCreate" class="col-form-label">Poli:</label>
                            <select class="form-control" name="station" id="stationCreate">
    ...
    <button type="button" id="btnOpenEditModal" data-bs-toggle="modal" data-bs-target="#editDoctorModal"
        style="display: none"></button>
    <div class="modal fade " id="editDoctorModal" tabindex="-1" role="dialog" aria-labelledby="editDoctorModalTitle"
        aria-hidden="true" data-bs-backdrop="static">
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editDoctorModalTitle"><b>Tambah Dokter</b></h5>
                ...
                <div class="modal-body">
                    <form action="" method="POST" id="formEditDoctor" enctype="multipart/form-data"
                        class="row">
                        ...
                        <div class="form-group col-xl-6 col-md-6 col-sm-12">
                            <label for="sipNumberEdit" class="col-form-label">No. SIP:</label>
                            <input type="text" class="form-control" name="sipNumber" id="sipNumberEdit"
                                placeholder="Masukkan nomor SIP">
                        </div>
                        <div class="form-group col-xl-6 col-md-6 col-sm-12">
                            <label for="stationEdit" class="col-form-label">Poli:</label>
                            <select class="form-control" name="station" id="stationEdit">
                                <option value="" disabled selected>Pilih Poli</option>
                                @foreach ($stations as $station)
                                    <option value="{{ $station }}">{{ $station }}</option>
                                @endforeach
...
@section('script')
    <script>
        ...
        function createData() {
            ...
            const formData = $('#formCreateDoctor').serialize();
            // Kirim data ke server dengan AJAX
            $.ajax({
                url: "{{ route('management.doctor.store') }}",
                type: 'POST',
                data: formData,
        ...
        function showEdit(identity) {
            ...
            // Kirim data ke server dengan AJAX
            $.ajax({
                url: "{{ route('management.doctor.show', 'harusGanti') }}".replace('harusGanti', identity),
                type: 'POST',
                success: function(response) {
                    ...
                    $('#sipNumberEdit').val(response.data.sip_number);
                    $('#stationEdit').val(response.data.station);
        ...
        function edit(text, identity) {
            // Ambil data dari form
            const formData = $('#formEditDoctor').serialize();

            // Kirim data ke server dengan AJAX
            $.ajax({
                url: "{{ route('management.doctor.update', 'harusGanti') }}".replace('harusGanti', identity),
                type: 'POST',
                data: formData,
                success: function(response) {
        ...
        function deleteData(text, identity) {
            ...
            // Kirim data ke server dengan AJAX
            $.ajax({
                url: "{{ route('management.doctor.delete', 'harusGanti') }}".replace('harusGanti', identity),
                type: 'POST',
                success: function(response) {
