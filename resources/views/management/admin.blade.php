...
@section('content')
        ...
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="createAdminModalTitle"><b>Tambah Dokter</b></h5>
                ...
                <div class="modal-body">
                    <form action="" method="POST" id="formCreateAdmin" enctype="multipart/form-data" class="row">
    ...
    <button type="button" id="btnOpenEditModal" data-bs-toggle="modal" data-bs-target="#editAdminModal"
    ...
    <div class="modal fade " id="editAdminModal" tabindex="-1" role="dialog" aria-labelledby="editAdminModalTitle"
        ...
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editAdminModalTitle"><b>Tambah Dokter</b></h5>
                ...
                <div class="modal-body">
                    <form action="" method="POST" id="formEditAdmin" enctype="multipart/form-data"
                        class="row">
    ...
    <script>
        ...
        function showAll() {
            ...
            var table = $('#adminTable').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('management.admin.index') }}",
                columns: [{
                        "data": 'DT_RowIndex',
                        orderable: false,
                        searchable: false,
        ...
        function createData() {
            ...
            const formData = $('#formCreateAdmin').serialize();
            // Kirim data ke server dengan AJAX
            $.ajax({
                url: "{{ route('management.admin.store') }}",
                type: 'POST',
                data: formData,
        ...
        function showEdit(identity) {
            ...
            // Kirim data ke server dengan AJAX
            $.ajax({
                url: "{{ route('management.admin.show', 'harusGanti') }}".replace('harusGanti', identity),
                type: 'POST',
                success: function(response) {
        ...
        function edit(text, identity) {
            // Ambil data dari form
            const formData = $('#formEditAdmin').serialize();
        ...
        function deleteData(text, identity) {
            ...
            // Kirim data ke server dengan AJAX
            $.ajax({
                url: "{{ route('management.admin.delete', 'harusGanti') }}".replace('harusGanti', identity),
                type: 'POST',
                success: function(response) {
